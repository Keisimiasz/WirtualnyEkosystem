...
void ZLab09::rozmiary() {
    cout << "--->Rozmiary" << endl
         ...
         << " Glon * :" << sizeof(Glon *) << endl
         << " Glon ** :" << sizeof(Glon **) << endl
         << " UstawieniaSymulacji :" << sizeof(UstawieniaSymulacji) << endl
         << " UstawieniaSymulacji * :" << sizeof(UstawieniaSymulacji *) << endl
         << " long:" << sizeof(long) << endl << endl;
}
...
void ZLab09::skalar() {
    ...
    *wskInt1D = 5;
    cout << "*wskInt1D = " << *wskInt1D << endl
         ...
         << "adres zapisany w wskInt1D ->" << wskInt1D << endl << endl;
    delete wskInt1D;
}
...
void ZLab09::referencja() {
    ...
    refInt = b; // Przypisanie wartości b do a przez refInt
    cout << "a=" << a << " b=" << b << endl;
    ...
    wskInt = &B;  // wskInt teraz wskazuje na B
    cout << "A=" << A << " B=" << B << endl;
